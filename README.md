...
Задание: ![image](https://github.com/user-attachments/assets/e647841c-e33a-4c6e-8b69-003a2eec6f5e)
## Реализация:
### Листинг программы:
```c++
﻿#include <iostream>
...
```
### Результат программы:
![image](https://github.com/user-attachments/assets/02fc49f9-9444-4fd1-9653-9ab31373b587)
